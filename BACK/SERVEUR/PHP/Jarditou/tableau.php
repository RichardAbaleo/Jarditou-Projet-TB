    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 table-responsive">
          <table class="table table-bordered">
            <tbody>
              ...
              <?php 
               ...
               if ($bloque == "<p class='text-center text-body bg-danger rounded-pill'>BLOQUE</p>") {

               } else if (($donnees['pro_stock']) != "0") {
          ...
          <a type="button" class="ml-3 btn btn-lg btn-warning active " href="identification.php">Mode admin</a>
          </br></br>
        </div>
      </div>
